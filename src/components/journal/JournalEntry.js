...
const JournalEntry = () => {
  ...
  return (
    <div className='flex items-center justify-between p-3 mb-6 transition-all duration-300 border cursor-pointer bg-primaryTransparent rounded-2xl hover:bg-gray-100 hover:border-strongGreen'>
